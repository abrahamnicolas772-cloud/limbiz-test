      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-8 border-b border-white/5">
          ...
          <form onSubmit={handleSubscribe} className="flex gap-2 w-full max-w-md">
            ...
            <button type="submit" className="px-5 py-2.5 bg-blue-600 hover:bg-blue-500 rounded-xl text-white text-sm font-semibold flex items-center gap-1.5 transition shadow-lg shadow-blue-500/20">Subscribe <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg></button>
          </form>
          
          {error && <p className="text-red-400 text-xs">{error}</p>}
          {subscribed && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center gap-2 text-green-400 text-xs">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="20 6 9 17 4 12"/></svg> Thank you!
            </motion.div>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-white/50 text-sm">
              ...
              <li><Link href="/tax-filings" className="hover:text-blue-400 transition">Tax Filings</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-white/50 text-sm">
              <li><Link href="/resources" className="hover:text-blue-400 transition">Startup Guides</Link></li>
              <li><Link href="/resources" className="hover:text-blue-400 transition">Templates</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-white/50 text-sm">
              ...
              <li><Link href="/accessibility" className="hover:text-blue-400 transition">Accessibility</Link></li>
              <li><Link href="/terms-of-use" className="hover:text-blue-400 transition">Website Terms</Link></li>
              <li><Link href="/consultation-agreement" className="hover:text-blue-400 transition">Consultation Agreement</Link></li>
              <li><Link href="/communications-policy" className="hover:text-blue-400 transition">Communications Policy</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-6 text-center text-white/10 text-[10px] leading-relaxed max-w-4xl mx-auto">
          LIMBIZ™ provides guidance, assistance, and support for business formation, credit readiness, funding preparation, tax setup, and digital presence. We do not guarantee funding, credit approval, tax outcomes, or government approval. State filing fees and processing times are subject to change. Please review our policies for complete terms.
        </div>
      </div>
    </footer>
  )

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-8 border-b border-white/5">
          <div className="flex items-center gap-3">
            <img src="/LOGO1.png" alt="LIMBIZ Logo" className="h-10 w-auto" />
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-white/5">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 text-white/40 text-sm">
            <a href="mailto:hello@limbiz.com" className="hover:text-blue-400 transition flex items-center gap-1.5">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg> hello@limbiz.com
            </a>
          ...
          <div className="text-white/20 text-xs text-center md:text-right">
            © {currentYear} Limitless Biz Hub LLC. All Rights Reserved.
          </div>
        </div>
